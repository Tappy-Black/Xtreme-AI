    ...
    if (cmd === "update") {
        ...
        try {
            ...
            const { data: commitData } = await axios.get(
                "https://api.github.com/repos/Tappy-Black/Xtreme-AI/commits/main"
            );
            ...
            const response = await axios({
                method: 'get',
                url: "https://github.com/Tappy-Black/Xtreme-AI/archive/main.zip",
                responseType: 'stream'
            });
            ...
            const sourcePath = path.join(extractPath, "Xtreme-AI-main");
